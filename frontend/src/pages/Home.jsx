          ...
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center">
              <div className="flex-shrink-0 flex items-center">
                <svg
                  className="h-8 w-auto fill-current text-purple-600"
                  viewBox="0 0 50 50"
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <path d="M25 2C12.3 2 2 12.3 2 25s10.3 23 23 23 23-10.3 23-23S37.7 2 25 2zm0 7c4.4 0 8 3.6 8 8s-3.6 8-8 8-8-3.6-8-8 3.6-8 8-8zm0 34c-6.1 0-11.5-3.1-14.7-7.8 2.2-4.2 6.4-7 11.5-7h6.4c5.1 0 9.3 2.8 11.5 7-3.2 4.7-8.6 7.8-14.7 7.8z" />
                </svg>
